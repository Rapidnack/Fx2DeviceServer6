...
module QsysCore_mm_interconnect_0 (
	...
	wire  [105:0] cmd_mux_src_data;                                                                                        // cmd_mux:src_data -> pio_0_s1_agent:cp_data
	wire          cmd_mux_src_ready;                                                                                       // pio_0_s1_agent:cp_ready -> cmd_mux:src_ready
	wire    [4:0] cmd_mux_src_channel;                                                                                     // cmd_mux:src_channel -> pio_0_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_001_src_data;                                                                                    // cmd_mux_001:src_data -> pio_1_s1_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                                                   // pio_1_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                                                                                 // cmd_mux_001:src_channel -> pio_1_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_002_src_data;                                                                                    // cmd_mux_002:src_data -> pio_2_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                                                   // pio_2_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                                                                 // cmd_mux_002:src_channel -> pio_2_s1_agent:cp_channel
	...
	wire  [106:0] pio_3_s1_agent_rf_source_data;                                                                           // pio_3_s1_agent:rf_source_data -> pio_3_s1_agent_rsp_fifo:in_data
	...
	wire  [106:0] pio_3_s1_agent_rsp_fifo_out_data;                                                                        // pio_3_s1_agent_rsp_fifo:out_data -> pio_3_s1_agent:rf_sink_data
	...
	wire  [105:0] cmd_mux_003_src_data;                                                                                    // cmd_mux_003:src_data -> pio_3_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                                                   // pio_3_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                                                 // cmd_mux_003:src_channel -> pio_3_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_004_src_data;                                                                                    // cmd_mux_004:src_data -> pio_4_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                                                   // pio_4_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                                                                 // cmd_mux_004:src_channel -> pio_4_s1_agent:cp_channel
	...
	wire  [105:0] spi_slave_to_avalon_mm_master_bridge_0_avalon_master_agent_cp_data;                                      // spi_slave_to_avalon_mm_master_bridge_0_avalon_master_agent:cp_data -> router:sink_data
	...
	wire  [105:0] pio_0_s1_agent_rp_data;                                                                                  // pio_0_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [105:0] pio_1_s1_agent_rp_data;                                                                                  // pio_1_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [105:0] pio_2_s1_agent_rp_data;                                                                                  // pio_2_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [105:0] pio_3_s1_agent_rp_data;                                                                                  // pio_3_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [105:0] pio_4_s1_agent_rp_data;                                                                                  // pio_4_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [105:0] router_src_data;                                                                                         // router:src_data -> spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                                                        // spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [4:0] router_src_channel;                                                                                      // router:src_channel -> spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter:cmd_sink_channel
	...
	wire  [105:0] spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter_cmd_src_data;                               // spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire    [4:0] spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter_cmd_src_channel;                            // spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [105:0] rsp_mux_src_data;                                                                                        // rsp_mux:src_data -> spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                                                       // spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [4:0] rsp_mux_src_channel;                                                                                     // rsp_mux:src_channel -> spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter:rsp_sink_channel
	...
	wire  [105:0] spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter_rsp_src_data;                               // spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter:rsp_src_data -> spi_slave_to_avalon_mm_master_bridge_0_avalon_master_agent:rp_data
	...
	wire    [4:0] spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter_rsp_src_channel;                            // spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter:rsp_src_channel -> spi_slave_to_avalon_mm_master_bridge_0_avalon_master_agent:rp_channel
	...
	wire    [4:0] spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter_cmd_valid_data;                             // spi_slave_to_avalon_mm_master_bridge_0_avalon_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	QsysCore_mm_interconnect_0_router_001 router_003 (
	...
	QsysCore_mm_interconnect_0_router_001 router_004 (
	...
	QsysCore_mm_interconnect_0_router_001 router_005 (
	...
	QsysCore_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                                                //       clk.clk
		.reset               (spi_slave_to_avalon_mm_master_bridge_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QsysCore_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                                                //       clk.clk
		.reset               (spi_slave_to_avalon_mm_master_bridge_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QsysCore_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                                                //       clk.clk
		.reset               (spi_slave_to_avalon_mm_master_bridge_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QsysCore_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                                                //       clk.clk
		.reset              (spi_slave_to_avalon_mm_master_bridge_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QsysCore_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                                                //       clk.clk
		.reset              (spi_slave_to_avalon_mm_master_bridge_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	QsysCore_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                                                //       clk.clk
		.reset              (spi_slave_to_avalon_mm_master_bridge_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
